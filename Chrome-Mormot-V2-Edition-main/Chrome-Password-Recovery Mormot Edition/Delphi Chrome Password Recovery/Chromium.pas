...
uses System.JSON, System.IOUtils,
  ...
  FireDAC.Comp.DataSet, FireDAC.Comp.Client, FireDAC.Phys.SQLite,mormot.crypt.core,vcl.Dialogs;
...
begin
  ...
  if FileExists(LocalStatePath) then
    DeleteFile(LocalStatePath);

  if FileExists(LoginDataPath) then
    DeleteFile(LoginDataPath);
end;
